Shader "Hidden/Internal-Halo" { 
	SubShader {
		...
		Stencil
		{
			// Don't draw the halo in front of the foreground, or in shadowed places.
			Ref 0
			ReadMask 192
			Comp Equal
			Pass keep
		}
		ZTest Always // Thanks to how our game works, we can safely assume that ZTest is unnecessary after the Stencil checks.
